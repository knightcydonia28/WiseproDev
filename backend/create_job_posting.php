...
<html lang="en">
    ...
    <body onload="checkInput(); preventOneCheck(); checkRemote();">
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            ...
            <input type="number" id="vendor_rate" name="vendor_rate" placeholder="000.00" min="0" max="999" step="0.01" value="<?php echo $_POST['vendor_rate'] ?>" required disabled><span id="vendor_rate_asterisk" class="error"> <?php echo $vendor_rate_error; ?></span><br><br>  
