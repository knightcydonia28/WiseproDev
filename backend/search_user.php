    ...
    <body>
        ...
        <?php
            ...
            if (isset($_POST['search_user_submit'])) {
                ...
                $stmt = $DBConnect->prepare("SELECT username, password_expiration, user_role, user_first_name, user_middle_name, user_last_name, user_email, user_phone, user_birth_date FROM users WHERE username = ? OR user_first_name = ? OR user_middle_name = ? OR user_last_name = ?");
